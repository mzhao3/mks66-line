...
color = [ 0, 255, 0 ]
'''
draw_line(250, 250, 500, 500, screen, [255,0,0])
draw_line(250, 250, 500, 0, screen, [255,0,0])

draw_line(0, 250, 500, 250, screen, [0,0,255])
draw_line(250, 0, 250, 500, screen, [0,0,255])
...
diffb = 6
while (i < 100) :
    draw_line(x1, y1, x0, y0, screen, [255-x0/2, 255-y0/2, x0+y0/4])
    draw_line(x1, y1, x2, y2, screen, [255-x1/2, 255-y1/2, x1+y1/4])
    draw_line(x2, y2, x3, y3, screen, [255-x2/2, 255-y2/2, x2+y2/4])
    draw_line(x0, y0, x3, y3, screen, [255-x3/2, 255-y3/2, x1+y3/4])
    x0 += diffa
    y0 += diffb
    x1 += diffb
    y1 -= diffa
